...
const tabTableData = [
  { id: 'dd-1', status: '상환완료' as const, name: '송암시스콤 LED', amount: '138,904,030', round: '45회차' },
  { id: 'dd-2', status: '상환완료' as const, name: '가양 ENT 보일러', amount: '346,000', round: '98회차' },
  { id: 'dd-3', status: '상환완료' as const, name: '마스턴172 성수 오피스 연료전지 구매', amount: '8,904,030', round: '5회차' },
  { id: 'dd-4', status: '상환완료' as const, name: '송암시스콤 LED', amount: '8,904,030', round: '18회차' },
  { id: 'dd-5', status: '상환예정' as const, name: '에너지엑스 빌딩 정보통신공사', amount: '56,904,543', round: '28회차' },
  { id: 'dd-6', status: '상환예정' as const, name: '광명전기 LED 교체', amount: '12,500,000', round: '12회차' },
  { id: 'dd-7', status: '미상환' as const, name: '인천항 냉동창고 절감', amount: '22,000,000', round: '3회차' },
  { id: 'dd-8', status: '미상환' as const, name: '엘엠에이티(LMAT) LED', amount: '38,000,000', round: '2회차' },
];
...
const bidItems = [
  ...
  { badge: '잔여일', name: '에너지엑스 빌딩 정보통신공사', amount: '76,909,003원', date: '유효기간 2029.05.06', badgeColor: '#6c757d' },
];

// ── 미상환 현황 ──────────────────────────────────────────────────────────────
const unpaidItems = [
  { badge: '마감일', name: '가양 ENT 보일러', amount: '138,909,003원', sub: '미상환 3회', badgeColor: '#ef4444' },
  { badge: '연체', name: '에너지엑스 빌딩 정보통신공사', amount: '76,909,003원', sub: '미상환 1회', badgeColor: '#1a56db' },
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                {noticesForWidget.map((n, i) => (
                  ...
                  >
                    ...
                    <span style={{ flexShrink: 0, fontSize: 10, color: '#6c757d', whiteSpace: 'nowrap' }}>
